        ...
        <div onClick={onClose} style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'rgba(0,0,0,0.75)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', padding: '0 16px 32px' }}>
          ...
          >
            ...
            <div style={{ padding: '24px 20px 28px' }}>
              ...
              {[
                { n: 1, text: 'Toque no botão Compartilhar na barra do Safari', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 2v13M8 6l4-4 4 4" stroke="#C9A84C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M20 16v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4" stroke="#C9A84C" strokeWidth="2" strokeLinecap="round"/></svg> },
                { n: 2, text: 'Role e toque em "Adicionar à Tela de Início"', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="4" stroke="#C9A84C" strokeWidth="2"/><path d="M12 8v8M8 12h8" stroke="#C9A84C" strokeWidth="2" strokeLinecap="round"/></svg> },
                { n: 3, text: 'Toque em "Adicionar" no canto superior direito', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M20 6L9 17l-5-5" stroke="#C9A84C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg> },
              ].map(step => (
                <div key={step.n} style={{ display: 'flex', gap: 14, alignItems: 'flex-start', marginBottom: 16 }}>
                  <div style={{ width: 36, height: 36, borderRadius: 10, flexShrink: 0, background: 'rgba(201,168,76,0.08)', border: '1px solid rgba(201,168,76,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>{step.icon}</div>
