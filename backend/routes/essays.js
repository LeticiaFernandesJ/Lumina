...
router.post('/analyze', auth, async (req, res) => {
  try {
    ...
    const prompt = `Você é professor especializado em redações. Analise a redação abaixo e responda APENAS com um objeto JSON válido, sem texto antes ou depois, sem markdown.
